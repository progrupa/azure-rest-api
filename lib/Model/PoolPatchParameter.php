...
/**
 * PoolPatchParameter Class Doc Comment
 *
 * @category    Class
 * @package     Progrupa\Azure
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PoolPatchParameter implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PoolPatchParameter';
    ...
    /**
     * Sets start_task
     * @param \Progrupa\Azure\Model\StartTask $start_task If omitted, any existing start task is left unchanged.
     * @return $this
     */
    ...
    /**
     * Sets metadata
     * @param \Progrupa\Azure\Model\MetadataItem[] $metadata If this element is present, it replaces any existing metadata configured on the pool. If you specify an empty collection, any metadata is removed from the pool. If omitted, any existing metadata is left unchanged.
     * @return $this
     */
