...
/**
 * JobScheduleStatistics Class Doc Comment
 *
 * @category    Class
 * @package     Progrupa\Azure
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class JobScheduleStatistics implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JobScheduleStatistics';
     ...
     * @param string $wall_clock_time The wall clock time is the elapsed time from when the task started running on a compute node to when it finished (or to the last time the statistics were updated, if the task had not finished by then). If a task was retried, this includes the wall clock time of all the task retries.
     * @return $this
     */
    ...
    /**
     * Sets wait_time
     * @param string $wait_time This value is only reported in the account lifetime statistics; it is not included in the job statistics.
     * @return $this
     */
