 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CloudTask implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CloudTask';
    ...
    protected static $swaggerTypes = [
        ...
        'stats' => '\Progrupa\Azure\Model\TaskStatistics',
    ...
    /**
     * Sets e_tag
     * @param string $e_tag This is an opaque string. You can use it to detect whether the task has changed between requests. In particular, you can be pass the ETag when updating a task to specify that your changes should take effect only if nobody else has modified the task in the meantime.
     * @return $this
     */
    ...
    /**
     * Sets previous_state
     * @param string $previous_state This property is not set if the task is in its initial Active state.
     * @return $this
     */
     ...
     * @param \DateTime $previous_state_transition_time This property is not set if the task is in its initial Active state.
     * @return $this
     */
    ...
    /**
     * Gets stats
     * @return \Progrupa\Azure\Model\TaskStatistics
     */
    ...
    /**
     * Sets stats
     * @param \Progrupa\Azure\Model\TaskStatistics $stats
     * @return $this
     */
    ...
    /**
     * Sets depends_on
     * @param \Progrupa\Azure\Model\TaskDependencies $depends_on The task will not be scheduled until all depended-on tasks have completed successfully. (If any depended-on tasks fail and exhaust their retry counts, the task will never be scheduled.)
     * @return $this
     */
